...
4. The task you care about is probably `rake deliverables`
...
Quarto can be configured by requiring `quarto` instead of `quarto/tasks`, and calling `Quarto.configure`:
